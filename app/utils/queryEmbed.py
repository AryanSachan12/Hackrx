...
class QueryProcessor:
    ...
    def format_query(self, query: str) -> str:
        ...
        question_words = ['what', 'how', 'when', 'where', 'why', 'who', 'which', 'can', 'is', 'are', 'do', 'does', 'did']
    ...
    def search_similar_chunks(self, 
        ...
        try:
                ...
                try:
                    ...
                    if 'namespaces' in index_stats:
                        ...
                        if namespace in namespaces:
                            ...
                            print(f"📂 Namespace '{namespace}' has {ns_stats.get('vector_count', 0)} vectors")
                        else:
            ...
            print(f"📊 Found {len(results)} total results, {len(filtered_results)} above threshold ({similarity_threshold})")
            ...
            if not filtered_results and results:
                ...
                for result in results:
                    score = result.get('score', 0.0)
                    print(f"   Score: {score:.4f} (below threshold {similarity_threshold})")
    ...
    def generate_prompt(self, query: str, context: str) -> str:
        ...
        5. If there are multiple relevant pieces of information, organize your answer clearly
        ...
        for query in test_queries:
            ...
            if 'chunks_metadata' in result:
                ...
                for chunk_meta in result['chunks_metadata']:
                    print(f"  - {chunk_meta['source_file']} (score: {chunk_meta['score']:.3f})")
